...
export default function Home() {
  const meta = {
    title: "VI Body Spa",
    description: "This is the best spa in the Virgin Islands. ",
  };
  return (
    <Layout meta={meta}>
      <Section>
        ...
        <div className="w-full lg:w-1/2 lg:pr-10">
          <div className="relative max-w-lg mx-auto font-sans leading-6 text-center text-gray-700 border-gray-200 lg:text-left">
            <h1 className="m-0 text-3xl font-bold leading-tight text-left text-gray-900 border-solid sm:text-4xl md:text-5xl">
              Enjoy our Spa <span className="block mt-4 font-sans text-left text-green-700">Next Great Idea</span>
            </h1>
            <p className="pr-5 mx-0 my-5 text-base text-left text-gray-500 lg:my-8 xl:text-lg">
              Organic Lux Spa located in Cruz Bay St. John USVI. Includes massage, custom Facials, & Nails. We are located right before the Westin in Palm Plaza
              on the right handside.s{" "}
            </p>
            <div className="relative flex items-center max-w-md leading-6 text-center lg:mx-0">
              <input
                type="text"
                placeholder="Your E-mail Address"
                className="w-full py-4 pr-0 m-0 overflow-visible font-medium duration-300 border-2 border-gray-200 rounded-full outline-none sm:py-5 sm:pr-48 cursor-text pl-7 focus:outline-none focus-within:border-green-700 hover:border-gray-400"
              />
              <button className="absolute right-0 h-12 px-8 mr-3 text-white bg-green-700 rounded-full">Book an appointment</button>
            </div>
        ...
        <div className="relative w-full mt-20 lg:w-1/2 lg:mt-0">
          <img
            src="https://secretoasisdayspa.com/wp-content/uploads/2015/04/massage-room-cropped.jpg"
          ...
          <div className="absolute top-0 right-0 w-full h-full mt-4 -mr-5 transform scale-125 rotate-45">
            <svg
              className="absolute top-0 w-full h-full transform fill-current lg:scale-x-150 text-gray-200"
              viewBox="0 0 200 200"
        ...
        <div className="max-w-6xl px-12 mx-auto bg-gray-100 md:px-16 xl:px-10">
          <div className="flex flex-col items-start lg:flex-row">
            <div className="flex flex-col items-start justify-center w-full h-full pr-8 mb-10 lg:mb-0 lg:w-1/2">
              <p className="mb-2 text-base font-medium tracking-tight text-green-500 ">Our customers ❤️ what we do.</p>
              ...
              <a
                href="#_"
                className="flex items-center justify-center px-8 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-green-600 border border-transparent rounded-md shadow hover:bg-green-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green md:py-4 md:text-lg md:px-10"
              >
      ...
      {/* <section className="py-20 bg-gray-50">
        <div className="max-w-6xl px-8 mx-auto lg:px-4">
          ...
          <div className="flex flex-wrap -mx-3">
            ...
            <div className="w-full px-3 mb-6 md:w-1/2 lg:w-1/3">
              <div className="px-8 pt-8 pb-8 text-center text-white transform scale-100 rounded-lg shadow-2xl lg:scale-105 bg-gradient-to-br from-blue-500 via-green-600 to-green-600">
                ...
                <div>
                  <a
                    className="block px-6 py-5 mb-4 text-base font-semibold leading-none text-center text-blue-600 rounded-lg bg-green-50 hover:bg-white sm:mb-0 hover:text-blue-700"
                    href="#"
                  >
                    Get Started
                  </a>
